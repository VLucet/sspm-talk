...
2.  Ingestion spatial boundaries

![](images/SFAs.png){fig-align="center"}

------------------------------------------------------------------------

### The `sspm` workflow

3.  Discretization of spatial boundaries into patches.

![](images/Discretized.png){fig-align="center"}

------------------------------------------------------------------------

### The `sspm` workflow

4.  Smoothing data using spatio-temporal GAMs smoothers.

------------------------------------------------------------------------

### The `sspm` workflow

5.  Computation of productivity values taking into account harvest information.
