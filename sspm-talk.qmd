...
```{=html}
<!--
Hi, My name is Val and today I will be presenting a R packaged developed for the management of northern shrimp fisheries 
-->
```
...
::: notes
I'd like to start with a timeless question in fisheries management: how much fish is there in a given stock, and how muchm is it safe to harvest? How does one go about counting fish?
:::
...
::: notes
Borrowing from an example by Jesse Agar from the CSF, let's imagine trying to count the amount of trees in a forest. Once you've decided what counts as a tree and not a bush or a sapling, you would like set up sampling areas across the forest.
:::
...
::: notes
Now imagine that the same idea for counting fish, except that fishes move, aggregate, are predated upon at different rates depending on where they move, and are harvested in fisheries. The specifics characteristics of fish populations makes the task of counting fish move beyond the simple sampling process I just described.
:::
...
Population models designed to answer applied resource management questions, such as **fisheries stock models**, increasingly address how the dynamics of stocks vary across space and time, and models increasingly incorporate environmental fluctuations.
:::
...
![](images/preds.png){fig-align="center"}
...
*Thanks to the members of the Pedersen Lab:*
