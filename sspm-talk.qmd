...
::: notes
The results from the model can be plotted. By default, the package plots the smoothed biomass, aling with the predictions and the correct prediction and or confidence intervals.
:::
